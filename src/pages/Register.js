                                            ...
                                            <Col md={6} sm={12}>
                                                <Form className="ekseerForm" style={{ textAlign: "left" }} onSubmit={handleRegisterSubmit}>
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col md={6} sm={6} style={{ width: '50%' }}>
                                                            <FormLabel htmlFor="copy_iqama_number" className="ekseerForm-label">Copy of ID/Iqama</FormLabel>
                                                    ...
                                                    <p className="forgetRegister">Already have account? <span onClick={redirectLogin}>Login here.</span></p>
                                                </Form>
                                            </Col>
                                        ...
                                        <Row className="wrapReverse">
                                            ...
                                            <Col md={6} sm={12}>
                                                <Form className="ekseerForm" style={{ textAlign: "right" }} onSubmit={handleRegisterSubmit}>
                                                    ...
                                                    <p className="forgetRegisterAr">هل لديك حساب مسجل؟<span onClick={redirectLogin}>تسجيل الدخول</span></p>
                                                </Form>
                                            </Col>
                                        </Row>
                                    </>
